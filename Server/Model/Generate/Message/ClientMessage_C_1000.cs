...
namespace ET
{
    ...
    [MemoryPackable]
    [Message(ClientMessage.Main2NetClinet_LoginGame)]
    [ResponseType(nameof(NetClient2Main_LoginGame))]
    public partial class Main2NetClinet_LoginGame : MessageObject, IRequest
    {
        public static Main2NetClinet_LoginGame Create(bool isFromPool = false)
        {
            return ObjectPool.Instance.Fetch(typeof(Main2NetClinet_LoginGame), isFromPool) as Main2NetClinet_LoginGame;
        }
    ...
    public static class ClientMessage
    {
        ...
        public const ushort Main2NetClinet_LoginGame = 1003;
